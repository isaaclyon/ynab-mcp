...
export const categoryId = categoryIdSchema.describe(
  "Category ID returned by ynab_list_categories.",
);
export const categoryGroupId = categoryGroupIdSchema.describe(
  "YNAB category group ID returned by ynab_list_categories.",
);
export const readPayeeId = payeeIdSchema.describe("Payee ID returned by ynab_list_payees.");
export const writePayeeId = untrimmedPayeeIdSchema.describe(
  "YNAB payee ID returned by ynab_list_payees.",
);
export const readTransactionId = transactionIdSchema.describe(
  "Transaction ID returned by ynab_search_transactions or transaction list tools.",
);
export const writeTransactionId = transactionIdSchema.describe(
  "YNAB transaction ID returned by ynab_search_transactions or transaction list tools.",
);
...
export const milliunits = milliunitsSchema.describe(
  "YNAB milliunits amount. For example, $12.34 is 12340.",
);
