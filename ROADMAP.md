...
- Add explicit write tools without exposing generic mutation; current write slices cover category/category-group create/update, month/category budgeted amount update, and single transaction create/update.
...
- Goal: Implement and test a TypeScript Streamable HTTP MCP server with read tools plus category/category-group, month/category budgeting, and transaction write slices.
